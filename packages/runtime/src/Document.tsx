...
export function Scripts() {
  const { pageData, initialData, matches, assetsManifest, ssr } = useAppContext();
  ...
  return (
    <>
      <script suppressHydrationWarning={!ssr} dangerouslySetInnerHTML={{ __html: `window.__ICE_APP_CONTEXT__=${JSON.stringify(appContext)}` }} />
      {
